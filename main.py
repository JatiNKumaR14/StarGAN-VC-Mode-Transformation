...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_step', type=int, default= 2000)#20) #2000)
    parser.add_argument('--model_save_step', type=int, default= 10000)#10) #10000)
    parser.add_argument('--lr_update_step', type=int, default= 100000)#20 )#100000)
